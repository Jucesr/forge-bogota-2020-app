...
var content = __webpack_require__(/*! !../../node_modules/css-loader!../../node_modules/sass-loader/dist/cjs.js!./Calibration.css */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/dist/cjs.js!./extensions/Measure/Calibration.css");
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!../../node_modules/sass-loader/dist/cjs.js!./Measure.css */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/dist/cjs.js!./extensions/Measure/Measure.css");
...
/**
                                                           ...
                                                           */
MeasureExtension.prototype.load = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {var self, viewer, measureToolOptions;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
          ...
          viewer.addEventListener(av.MODEL_REMOVED_EVENT, this.onModelRemoved);case 32:case "end":return _context.stop();}}}, _callee, this);}));
...
function MeasureTool(viewer, options, sharedMeasureConfig, snapper)
{
  ...
  /**
     ...
     */
  this.setMeasurements = function (measurements) {var _this = this;
    ...
    for (var i = 0; i < measurements.length; i++) {
      var measureData = measurements[i];

      var unitType = measureData.unitType;
      var precision = measureData.precision;
      ...
      var attachIndicatorCb = function attachIndicatorCb(measurement) {
        ...
        measurement.attachIndicator(_viewer, _this, _MeasureToolIndicator__WEBPACK_IMPORTED_MODULE_1__["MeasureToolIndicator"]);
...
function MeasureToolIndicator(viewer, measurement, measureTool)
{
  ...
  this.endpoints = [];
  this.lines = {
    xyz: { axis: false, material: createLineMaterial(measurement.lineColor ? measurement.lineColor : '005BCE'), className: 'adsk-icon-axis-delta' + '-xyz measure-label-axis-delta' + ' measure-label-axis-xyz' },
...
proto.renderFromPoints = function (points, showMeasureResult) {
  _Indicator__WEBPACK_IMPORTED_MODULE_0__["Indicator"].prototype.renderFromPoints.call(this, points, showMeasureResult);
...
proto.init = function () {
  ...
  // Create a button for Line Color.
  this.measureLineColorBtn = new avu.Button("toolbar-measureTool-simple-distance");
  this.measureLineColorBtn.setGlobalManager(this.globalManager);
  this.measureLineColorBtn.setToolTip("Line Color");
  this.measureLineColorBtn.setIcon("adsk-icon-measure-distance-new");
  this.measureLineColorBtn.onClick = function () {
    var enable = self.measureLineColorBtn.getState() !== avu.Button.State.ACTIVE;
    if (enable) {
      self.measureExtension.activate('line_color');
    } else {
      self.measureTool.deselectAllMeasurements();
    }
  };

  this.measureToolbar.addControl(this.measureLineColorBtn);
  this.buttonsList[MeasureCommon.MeasurementTypes.MEASUREMENT_DISTANCE] = this.measureLineColorBtn;
...
proto.createMeasurementFromData = function (measurementData, measurementType, createIndicatorCb, preparePicksCb) {var _this = this;
  ...
  this.currentMeasurement.lineColor = measurementData.lineColor;
  ...
  var convertUnits = function convertUnits(value, square) {
    return Autodesk.Viewing.Private.convertUnits(
    measurementData.sharedUnits,
    _this.viewer.model.getUnitString(),
  ...
  var getIntersectPoints = function getIntersectPoints() {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/dist/cjs.js!./extensions/Measure/Calibration.css":
/*!*************************************************************************************************************!*\
